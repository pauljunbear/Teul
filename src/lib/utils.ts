    ...
    if (step === 9) {
      ...
      if (mode === 'light') {
        ...
        if (step < 9) {
          // Darker backgrounds
          const t = (9 - step) / 8;
          lightness = baseLightness - (baseLightness - 0.1) * t;
